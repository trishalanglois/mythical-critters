...
describe('Werewolf', function() {
  ...
  it('should start off not hungry', function() {
    var werewolf = new Werewolf('Willa', 'Toronto');
  ...
  it('should be able to eat(victim) once hungry', function() {
    var werewolf = new Werewolf('Willa', 'Toronto');
    var victim = new Victim('Trisha', 'Denver');
    werewolf.change();
    werewolf.eat(victim);
  ...
  it('should not be hungry after changing back to human form', function() {
    var werewolf = new Werewolf('Dave', 'Phish Concert');
    werewolf.change();
    werewolf.change();
    assert.equal(werewolf.hungry, false);
  });
  ...
  it('should change back to human form after eating', function() {
    var werewolf = new Werewolf('Trisha', 'den');
  ...
  it('should not be able to consume victim in human form', function() {
    var werewolf = new Werewolf ('Elise', 'Tilla');
    var victim = new Victim ('Brad', 'Tilla');
    werewolf.change();
    werewolf.eat(victim);
    assert.equal(werewolf.eat(victim), "I'm no cannibal.");
  });
});
